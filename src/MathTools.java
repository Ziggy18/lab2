public class MathTools {
    ...
    public static Coordinate barycentric(int x, int y, Coordinate xtr, Coordinate ytr){
        double x0=xtr.getX(); double x1=xtr.getY(); double x2=xtr.getZ();
        double y0=ytr.getX(); double y1=ytr.getY(); double y2=ytr.getZ();
    ...
    public static Coordinate normal(Coordinate c0, Coordinate c1, Coordinate c2){
        double x0=c0.getX(); double x1=c1.getX(); double x2=c2.getX();
        double y0=c0.getY(); double y1=c1.getY(); double y2=c2.getY(); 
        double z0=c0.getZ(); double z1=c1.getZ(); double z2=c2.getZ();
        return new Coordinate(
